package com.f55119006.githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("F55119006_List of Users");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
